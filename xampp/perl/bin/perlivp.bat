...
#!perl
#line 29
    eval 'exec C:\Users\akhan\Downloads\xampp-win32-5.6.38-0-VC11\xampp\perl\bin\perl.exe -S $0 ${1+"$@"}'
...
my $perlpath = 'C:\Users\akhan\Downloads\xampp-win32-5.6.38-0-VC11\xampp\perl\bin\perl.exe';
