...
FOR %%x IN ("C:\Users\akhan\Downloads\xampp-win32-5.6.38-0-VC11\xampp\php\pear") DO (if %%x=="%PMTPMTPMT%" GOTO :NOTINSTALLED)

REM Check PEAR global ENV, set them if they do not exist
IF "%PHP_PEAR_INSTALL_DIR%"=="" SET "PHP_PEAR_INSTALL_DIR=C:\Users\akhan\Downloads\xampp-win32-5.6.38-0-VC11\xampp\php\pear"
IF "%PHP_PEAR_BIN_DIR%"=="" SET "PHP_PEAR_BIN_DIR=C:\Users\akhan\Downloads\xampp-win32-5.6.38-0-VC11\xampp\php"
IF "%PHP_PEAR_PHP_BIN%"=="" SET "PHP_PEAR_PHP_BIN=C:\Users\akhan\Downloads\xampp-win32-5.6.38-0-VC11\xampp\php\php.exe"
GOTO :INSTALLED
