...
if "%PHPBIN%" == "" set PHPBIN=C:\Users\akhan\Downloads\xampp-win32-5.6.38-0-VC11\xampp\php\.\php.exe
if not exist "%PHPBIN%" if "%PHP_PEAR_PHP_BIN%" neq "" goto USE_PEAR_PATH
GOTO RUN
:USE_PEAR_PATH
set PHPBIN=%PHP_PEAR_PHP_BIN%
:RUN
"%PHPBIN%" "C:\Users\akhan\Downloads\xampp-win32-5.6.38-0-VC11\xampp\php\phpunit" %*
